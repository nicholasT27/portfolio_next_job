...
<div id="indicators-carousel" class="relative w-full mt-2" data-carousel="static">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-80">
         <!-- Item 1 -->
        <div id="carousel-item-1" class="carousel-item hidden" data-carousel-item="active">
           <div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 overflow-y-auto h-80">
                    <!-- Job Title section -->
                        <div class="sm:col-span-6 mt-8">
                            <label for="job-title" class="block text-sm font-medium leading-6 text-gray-900 p-1">Job Title</label>
                                <div class="mt-1 p-1">   
                                    <input type="text" name="job-title" id="job-title" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Software Engineer">        
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                <label for="min-annual" class="block text-sm font-medium leading-6 text-gray-900 p-1">Min Annual Compensation</label>
                                    <div class="mt-1 p-1">
                                        <input type="number" name="min-annual" id="min-annual" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="40000">
                                    </div>
                            </div>

                            <!-- Max Annual Compensation section -->
                            <div class="sm:col-span-3">
                                <label for="max-annual" class="block text-sm font-medium leading-6 text-gray-900 p-1">Max Annual Compensation</label>
                                    <div class="mt-1 p-1">
                                        <input type="number" name="max-annual" id="max-annual" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="250000">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="carousel-item-2" class="carousel-item hidden" data-carousel-item>
             <div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 bg-slate-50 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
                <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 overflow-y-auto h-80 mb-4">

                    <!-- Company Name section -->
                        <div class="sm:col-span-6 mt-8">
                            <label for="company-name" class="block text-sm font-medium leading-6 text-gray-900">Company Name</label>
                                <div class="mt-1 p-1">
                                    <input type="text" name="company-name" id="company-name" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="e.g. Facebook">
                                </div>
                        </div>

                    <!-- Job Location section -->
                        <div class="sm:col-span-6 mb-8">
                            <label for="job-location" class="block text-sm font-medium leading-6 text-gray-900">Job Location</label>
                                <div class="mt-2">
                                    <input type="text" name="job-location" id="job-location" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="e.g. Singapore">
                                </div>
                        </div>
                </div>
            </div>
             ...
             <div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 bg-slate-50 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 overflow-y-auto h-80">
                    ...
                    <div class="sm:col-span-6 p-1">
                        <label for="company-name" class="block text-sm font-medium leading-6 text-gray-900 mt-4">Description</label>
                        <div class="mt-1 p-1">
                            <textarea type="text" name="description" id="description" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl w-full h-56 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Job Description"></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="carousel-item-4" class="carousel-item hidden" data-carousel-item>
             <div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 bg-slate-50 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 overflow-y-auto h-80">
                    ...
                    <div class="sm:col-span-6 p-1">
                        <label for="company-name" class="block text-sm font-medium leading-6 text-gray-900 mt-4">Requirements</label>
                            <div class="mt-1 p-1">     
                                <textarea type="text" name="requirements" id="requirements" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl w-full h-56 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Job Requirement"></textarea>
                            </div>
                    </div>
                </div>
            </div>
        ...
        <div id="carousel-item-5" class="carousel-item hidden" data-carousel-item>
             <div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 bg-slate-50 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 overflow-y-auto h-80">
                    ...
                    <div class="sm:col-span-6 p-1">
                        <label for="company-name" class="block text-sm font-medium leading-6 text-gray-900 mt-4">How to Apply ?</label>
                            <div class="mt-2">
                                <textarea type="text" name="requirements" id="requirements" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl w-full h-56 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Instruction to Apply This Job"></textarea>
                            </div>
                    </div>
                </div>
            </div>
    ...
    <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
        ...
        <button id="carousel-indicator-3" type="button" class="w-3 h-3 rounded-full"></button>
        <button id="carousel-indicator-4" type="button" class="w-3 h-3 rounded-full"></button>
        <button id="carousel-indicator-5" type="button" class="w-3 h-3 rounded-full"></button>
    </div>
...
<!-- prev button -->
<button on:click={prevSlide} type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-full text-sm h-10 w-10 text-center mr-2 mb-2
...
<!-- Next Button -->
<button on:click={nextSlide} type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-full text-sm h-10 w-10 text-center mr-2 mb-2
  flex items-center justify-center shadow-md">
            <svg class="w-4 h-4 text-white dark:text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
...
<!-- cancel -->
<button on:click={popUpModal} data-modal-target="popup-modal" data-modal-toggle="popup-modal" type="button" class="slide-up bounce text-white bg-rose-400 focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-full text-sm h-10 w-10 text-center mr-2 mb-2
  flex items-center justify-center shadow-md ">
...
<!-- Modal Overlay with background blur -->
  <div class="fixed inset-0 bg-gray-800 bg-opacity-50 backdrop-blur-md"></div>
...
<div id="popup-modal" tabindex="-1" class="p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button on:click={hideModal} type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal">
            ...
            <div class="p-6 text-center">
                ...
                <button on:click={refreshPage} data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
