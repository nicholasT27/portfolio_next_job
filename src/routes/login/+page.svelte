  ...
  <div id="flip-card" class="sm:w-6/12 w-full h-full">
      <div id="flip-card-inner" class="flip-card-inner">
        <div class="flip-card-front w-full h-full">
          ...
          <!-- Log In Section -->
            <div class="absolute text-gray-200 m-2 top-72 sm:top-48 left-40 sm:left-80 text-5xl font-bold slideRight">
                <div class="flex">
        ...
        <div class="flip-card-back flex justify-center bg-gradient-to-br from-pink-500 to-orange-400">
            ...
            {#if $getError}
            <div class="flex absolute z-10 top-2 left-1 warningMessageSlideRight items-center p-4 text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-red-400" role="alert">
           ...
           <div class="flex justify-center w-9/12 ml-2 sm:ml-10 mb-5">
                  <div class="w-full h-fit max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow mt-32">
                      ...
                      <!-- username section -->
                        <div>
                            <label for="username" class="block mb-2 text-lg sm:text-base font-medium text-gray-900 text-left">Your username</label>
                            <input type="text" 
                            name="username" 
                        ...
                        <!-- password section -->
                        <div>
                                <label for="password" class="block pb-1 text-lg sm:text-base font-medium text-gray-900 dark:text-white text-left">Your password</label>
                                    <div class="relative">
                                        {#if showPassword}
               ...
               name="password"
               placeholder="••••••••" 
               class="bg-white border border-gray-300 text-gray-900 text-base sm:text-sm rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5" required
               bind:value={password}
        >
    ...
    {/if}
                        ...
                        <button type="submit" class="w-full text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                          {#if $isLoading}
                        ...
                        <div class="font-medium text-gray-500 text-base sm:text-sm">
                            Not registered? <a href="/sign-up" class="text-pink-600 hover:underline">Create Account</a>
                        </div>
                      </form>
                  </div>
           </div>
    ...
    <!-- Form div -->
    <div class="flex items-center flex-col justify-center w-7/12 bg-gradient-to-br from-pink-500 to-orange-400 formDivision">
            <!-- If loginStatus is true, show the warning message -->
            {#if $getError}
            <div class="flex absolute z-10 top-2 left-1 warningMessageSlideRight items-center p-4 text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
