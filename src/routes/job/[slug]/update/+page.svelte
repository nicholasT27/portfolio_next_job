...
<div class="flex h-screen w-screen">
	...
	<div class="flip-card-back flex flex-col h-full p-2 md:hidden block">
            ...
            <div class="flex flex-row">
              <svg class="w-3 h-3 mt-3 mr-2 text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
			...
			<form on:submit={updateJob} class="w-full h-5/6 mt-16 flex items-center carousel-form-division">
							<div class="pb-2 w-full h-full">
								...
								<div id="indicators-carousel" class="flip-back-card-division relative w-full h-5/6" data-carousel="static">
										...
										<div
											...
											>
												<div
													class="grid grid-cols-1 gap-x-6 gap-y-8 overflow-y-auto h-96"
												>
														...
														<div class="mt-2 py-4"> 
															...
															<ul class="w-72 ml-1 text-sm font-medium text-gray-900 bg-transparent rounded-lg  dark:bg-gray-700 dark:border-gray-600 dark:text-white">
    															<li class="rounded-t-lg dark:border-gray-600">
																	...
																	<!-- full time selection -->
            														<input id="list-checklist-full" type="checkbox" value="" name="list-checklist" class="w-6 h-6 rounded-full text-pink-600 bg-gray-100 border-gray-300 focus:ring-3 focus:ring-pink-600 checked:bg-pink-600 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500">
            														<label for="list-checklist-full" class="w-full ml-2 text-xl font-medium text-gray-900 dark:text-gray-300">Full Time</label>
			
																	<!-- part time selection -->
																	<input id="list-checklist-part" type="checkbox" value="" name="list-checklist" class="w-6 h-6 rounded-full text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-600 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500">
            														<label for="list-checklist-part" class="w-full ml-2 text-xl font-medium text-gray-900 dark:text-gray-300">Part Time</label>
		
																	<!-- remote selection -->
																	<input id="list-checklist-remote" type="checkbox" value="" name="list-checklist" class="w-6 h-6 rounded-full text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-600 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500">
           															<label for="list-checklist-remote" class="w-full ml-2 text-xl font-medium text-gray-900 dark:text-gray-300">Remote</label>
									...
									<div id="flip-card-carousel-item-2" class="carousel-item hidden" data-carousel-item>
												<div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 bg-slate-50 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
													<div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 overflow-y-auto h-96">
													...
													<div class="sm:col-span-6 col-span-full p-2">												
														<label for="photo" class="block text-xl font-medium leading-6 text-gray-900">Upload Company Logo Image</label>
														<div class="mt-2 flex items-center gap-x-3">
															...
															<label for="file-upload" class="rounded-md bg-white px-2.5 py-1.5 text-xl font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
															<input type="file" name="file-upload" class="sr-only" id="file-upload"
															on:change={handleFileInputChange}
															accept=".jpg, .jpeg, .png"/>
															<span>Change Image</span>
															</label>
															<label for="fileInput" class="text-gray-500 h-4 flex items-center text-xl">{selectedFile}</label>
														</div>
													</div>
										...
										<div id="flip-card-carousel-item-3" class="carousel-item hidden" data-carousel-item>
											<div class="block absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 bg-slate-50 p-8 border round rounded-xl bg-gradient-to-br from-pink-500 to-orange-400">
												<div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 overflow-y-auto h-96">
													<!-- Decription section -->
									...
									<div class="carousel-indicator absolute z-30 flex space-x-3 -translate-x-1/2 bottom-12 left-1/2">
										...
										<button id="flip-card-carousel-indicator-4" type="button" class="w-3 h-3 rounded-full" />
										<button id="flip-card-carousel-indicator-5" type="button" class="w-3 h-3 rounded-full" />
									</div>
								</div>
...
<ul class="w-72 ml-1 text-sm font-medium text-gray-900 bg-transparent rounded-lg  dark:bg-gray-700 dark:border-gray-600 dark:text-white">
    <li class="rounded-t-lg dark:border-gray-600">
        <div class="flex items-center mt-1 py-3">
			...
			<!-- full time selection -->
            <input id="list-checklist-full" type="checkbox" bind:checked={$isFullTime} name="list-checklist" class="w-4 h-4 rounded-full text-pink-600 bg-gray-100 border-gray-300 focus:ring-3 focus:ring-pink-600 checked:bg-pink-600 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500">
            <label for="list-checklist-full" class="w-full ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Full Time</label>
			
			<!-- part time selection -->
			<input id="list-checklist-part" type="checkbox" bind:checked={$isPartTime} name="list-checklist" class="w-4 h-4 rounded-full text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-600 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500">
            <label for="list-checklist-part" class="w-full ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Part Time</label>
		
			<!-- remote selection -->
			<input id="list-checklist-remote" type="checkbox" bind:checked={$isRemote} name="list-checklist" class="w-4 h-4 rounded-full text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-600 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500">
          ...
          <div class="mt-2 flex items-center gap-x-3">
			...
			{#if $isUpload}
            <label for="fileInput" class="text-gray-500 h-4 flex items-center">{selectedFile.slice(0, 10)}...</label>
			{:else}
			<label for="fileInput" class="text-gray-500 h-4 flex items-center">{data.job.image_url.slice(0,20)}...</label>
			{/if}
          </div>
