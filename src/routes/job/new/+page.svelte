		...
		<div id="flip-card-inner" class="flip-card-inner">
			<div class="flip-card-front w-full h-full">
				...
				>
					...
					<h1>Post a job</h1>
					<p class="form-page-intro">Bring great people<br />to your next chapter.</p>
					<p class="form-page-note">Tell the story of the role your team is ready to fill.</p>
				</div>
				...
				>
					<div class="pb-2 w-full h-full">
						<div class="flex flex-col">
							...
							<p class="form-public-note mt-5 text-xl leading-6">
						...
						<div class="pb-2 ">
							<div class="flex">
								...
								<h2 class="text-base font-semibold leading-7 text-gray-900 flex items-center">
									...
									<p class="form-public-note mt-1 text-sm leading-6">
								This information will be displayed publicly so be careful what you share.
							</p>
...
<!-- Visual-only refinement: the existing carousel, inputs, upload handlers and submit flow remain intact. -->
<style>
	...
	/* Full-page visual composition; the form fields, carousel steps, and submit handler are unchanged. */
	...
	/* Desktop glass-panel composition. The carousel steps, field names, uploads and create handler are unchanged. */
	...
	:global(.form-page-shell .flip-card-front .slideRight) { animation: create-job-hero-in .6s cubic-bezier(.22, 1, .36, 1) both; }
	:global(.form-page-shell .formDivision .slide-down) { animation: none; }
	@keyframes create-job-hero-in { from { opacity: 0; transform: translate(-2.5rem, -50%); } to { opacity: 1; transform: translate(0, -50%); } }
	@keyframes create-job-panel-in { from { opacity: 0; transform: translate(2.5rem, -50%); } to { opacity: 1; transform: translate(0, -50%); } }
	@media (min-width: 768px) {
		:global(.form-page-shell .flip-card-front > .absolute) { transform: translateY(-50%) !important; }
		:global(.form-page-shell > .formDivision) { animation: create-job-panel-in .55s cubic-bezier(.22, 1, .36, 1) both; }
	}
