...
<div class="flex h-screen w-screen">
    ...
    <div id="flip-card" class="sm:w-6/12 w-full h-full">
      <div id="flip-card-inner" class="flip-card-inner">
        ...
        <div class="absolute text-gray-200 m-2 left-14 top-72 sm:top-52 text-5xl font-bold slideRight">
            <div class="flex">
    ...
    <div class="flip-card-back flex justify-center bg-gradient-to-br from-pink-500 to-orange-400 block md:hidden">
        <!-- If getError, show the warning message -->
            ...
            {#if $getSuccess}
            <div class="z-10 border border-black flex absolute top-2 left-1 items-center p-4 text-green-800 rounded-lg bg-green-50 slideRight" role="alert">
            ...
            <div class="flex w-9/12 h-full items-center justify-center ml-5">
                 <!-- Form section -->
                  <div class="w-full h-fit p-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow overflow-y-auto flip-card-back-form">
                        <form class="space-y-3" on:submit={createUser}>
                              <div class="flex">
                               ...
                               <!-- username section -->
                            <div>
                                <label for="username" class="block pb-1 text-lg font-medium text-left text-gray-900">Your username</label>
                                <input type="text" name="username" class="bg-white border border-gray-300 text-gray-900 text-base rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John Doe" required
                                >
          <div class="mt-2 flex items-center gap-x-3">
            ...
            <label for="fileInput" class="text-gray-500 h-4 flex items-center">{selectedFile}</label>
                            ...
                            <!-- email section -->
                            <div>
                                <label for="email" class="block pb-1 text-lg font-medium text-gray-900 text-left">Your Email</label>
                            ...
                            <!-- password section -->
                            <div>
                                <label for="password" class="block pb-1 text-lg font-medium text-gray-900 text-left">Your password</label>
                                    <div class="relative">
                                        <input type={showPassword ? "password" : "text"} 
                                        name="password" 
                                        placeholder="••••••••" 
                                        class="bg-white border border-gray-300 text-gray-900 text-lg rounded-full focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required
                                        >
                            ...
                            <div>
                                <label for="password-confirmation" class="pb-1 block text-lg font-medium text-gray-900 text-left">Confirm password</label>
                                <div class="relative">
                            ...
                            <button type="submit" class="w-full text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            {#if $isLoading}
          ...
          <div class="mt-2 flex items-center gap-x-3">
            ...
            <label for="fileInput" class="text-gray-500 h-4 flex items-center">{selectedFile}</label>
                            ...
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Registered? <a href="/login" class="text-pink-600 hover:underline dark:text-blue-500">Log in HERE</a>
                            </div>
                        </form>
                    </div>
              </div>
