...
<style>
	...
	.home-hero-copy h1 { max-width: 22rem; margin: 0; color: #fff; font-size: clamp(3.2rem, 6vw, 5.8rem); font-weight: 900; letter-spacing: -.035em; line-height: .94; }
	...
	@media (max-width: 960px) { .home-hero { min-height: 31rem; background-position: 58% top; } .home-hero-copy { --home-hero-offset: 0rem; padding: 3.5rem 2rem; } .home-hero-copy h1 { max-width: 22rem; font-size: clamp(3rem, 7.5vw, 4.6rem); } .home-results { flex-direction: column !important; } .home-filters { width: 100%; flex: 0 0 auto; } .home-job-list { width: 100%; } }
