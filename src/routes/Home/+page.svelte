...
<style>
	...
	.home-filters input[type='checkbox'] { width: 1.25rem; height: 1.25rem; appearance: none; border: 0 !important; border-radius: 999px !important; background: transparent !important; cursor: pointer; }
	.home-filters input[type='checkbox']:checked { background: radial-gradient(circle, #d65391 0 .31rem, transparent .34rem) !important; }
	...
	@media (max-width: 700px) { .home-hero { min-height: 30rem; background-position: 61% top; } .home-hero-copy { --home-hero-offset: 0rem; padding: 2rem 1.25rem; } .home-hero-copy h1 { max-width: 16rem; font-size: clamp(2.45rem, 11vw, 3.25rem); line-height: .98; } .home-hero-copy span { max-width: 17rem; margin-top: 1rem; font-size: 1rem; } .home-hero-copy a { width: min(16rem, 100%); margin-top: 1.5rem; } .home-controls { width: calc(100% - 2rem); margin-top: 1rem; } .home-results { width: 100%; flex-direction: column !important; padding: .5rem 1rem 2rem; } .home-filters { width: auto; flex: 0 0 auto; padding: 0; border: 0; box-shadow: none; background: transparent; } .home-filters > button { display: inline-flex !important; align-self: flex-start; margin: .5rem 0 !important; } .home-job-list { width: 100%; margin-left: 0 !important; } .home-job-list #job-listing { padding: 1rem !important; } }
