...
<style>
	...
	.home-hero-copy { --home-hero-offset: 8.75rem; position: relative; z-index: 1; display: grid; align-content: center; width: min(72.5rem, 100%); padding: 4.5rem 2rem; text-shadow: 0 2px 16px rgb(0 0 0 / 30%); animation: home-hero-enter 720ms cubic-bezier(.22,1,.36,1) both; }
	.home-hero-copy p { margin: 0 0 1.25rem; font-size: .78rem; font-weight: 900; letter-spacing: .18em; }
	.home-hero-copy h1 { max-width: 24rem; margin: 0; color: #fff; font-size: clamp(3.2rem, 6vw, 5.8rem); font-weight: 900; letter-spacing: -.065em; line-height: .94; }
